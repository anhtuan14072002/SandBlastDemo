...
{
    private ColoringRegionsAsset asset;
    ...
    private bool removeAttachedTexture = true;
    private bool removeMerged = true;
    ...
    // Regions list scroll
    private Vector2 scrollRegions;
    private float regionsListHeight = 170f;
    ...
    private void OnGUI()
    {
        ...
        asset.sourceTexture = (Texture2D)EditorGUILayout.ObjectField("Source Texture", asset.sourceTexture, typeof(Texture2D), false);
        ...
        {
            EditorGUILayout.HelpBox("Texture chưa bật Read/Write Enabled. Bật trong Import Settings rồi Reimport.", MessageType.Error);
            return;
        }
    ...
    private void DrawRegionsPanel()
    {
        ...
        if (sel && !selectionMode) { selectionMode = true; addMode = false; }
        if (add && !addMode) { addMode = true; selectionMode = false; }
